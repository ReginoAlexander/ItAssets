...
require __DIR__ . '/../../app/config/login.php';
...
<div class="page page-center">
	<div class="container container-tight py-4">
		...
		<div class="text-center mb-4">
            ...
            <img src="/ItAssets/public/assets/img/logo.jpeg" alt="" width="110" height="32" viewBox="0 0 232 68" class="navbar-brand-image">
    ...
    <div class="card card-md">
        <div class="card-body">
            <h2 class="h2 text-center mb-4">Entra a tu cuenta</h2>
            ...
            <form action="/ItAssets/public/login" method="POST" autocomplete="off" novalidate="">
                <div class="mb-3">
                    <label class="form-label">Usuario</label>
                    <input type="text" class="form-control" placeholder="tu usuario" autocomplete="off" name="username" >
                </div>
                ...
                <div class="mb-2">
                    ...
                    <div class="input-group input-group-flat">                   
                        <input type="password" class="form-control" placeholder="tu contrasena" autocomplete="off" name="password">
                    </div>
                </div>
